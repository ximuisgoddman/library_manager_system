...
urlpatterns = [
    ...
    path('increase-collects/<int:id>/', views.IncreaseCollectsView.as_view(), name='increase_collects'),
    # 列表类视图
    ...
    path('user_article_list/<int:user_id>/', views.user_article_list, name='user_article_list'),
]
