...
# app.autodiscover_tasks(['article.tasks.update_article_likes_collect',
#                         'online_song.tasks.sync_upload_song',
#                         'online_books.tasks.sync_upload_online_book',
#                         'books.tasks.sync_upload_book'])
